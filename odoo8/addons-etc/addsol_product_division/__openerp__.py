...
##############################################################################
{
    'name' : 'Addsol-Product Division',
    'summary': 'Product-Wise Quantity Divide In Date Range',
    'description' : """
...
Features:
---------
    * Product-Wise Quantity Divide In Date Range
""",
    ...
    'data': [
        ...
        #'templates.xml',
        'addsol_product_division_view.xml',
    ],
    'demo': [],
    'test': [],
    'installable': True,
