...
class addsol_secondary_movement(models.Model):
    _name = 'addsol.secondary.movement'
    ...
    secondary_movement_line_ids = fields.One2many('addsol.secondary.movement.line', 'secondary_movement_id', "Stockistwise Movement")
    
    
class addsol_secondary_movement_line(models.Model):
    _name = 'addsol.secondary.movement.line'
    ...
    secondary_movement_id = fields.Many2one('addsol.secondary.movement')
